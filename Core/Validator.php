...
class Validator {
    ...
    private const SCHEMA_LIST = [
        'env' => ['schema://ecmchow/smtp-mailer/env.json', 'env.json'],
        'sendMail' => ['schema://ecmchow/smtp-mailer/sendMail.json', 'sendMail.json'],
        'updateQueuedMail' => ['schema://ecmchow/smtp-mailer/updateQueuedMail.json', 'updateQueuedMail.json']
    ];
    ...
    /**
     * queue JSON file name pattern
     * @var string
     */
    public const QUEUE_FILE_REGEX = "/^mail_([0-9]+)\.([0-9]+)_([a-z0-9]+)\.json/";

    /**
     * Redis queue key name pattern
     * @var string
     */
    public const REDIS_QUEUE_REGEX = "/^([\d]+)\.([\d]+)_([a-z0-9]+)/";

    /**
     * queue JSON file name pattern
     * @var string
     */
    public const TEMPLATE_FILE_REGEX = "/^[^.].*$/";
